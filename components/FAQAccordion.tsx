    ...
    <div className="border-b border-[#D4C9B8] last:border-b-0">
      ...
      >
        <div className="flex items-start gap-3">
          <span
            className="shrink-0 text-[#B01E33] font-bold text-sm mt-0.5"
            style={{ fontFamily: "var(--font-cormorant)" }}
          >
            Q
          </span>
          <span
            className="text-[#002B5C] font-bold group-hover:text-[#B01E33] transition-colors duration-300"
        ...
        <motion.div
          ...
          className="shrink-0 w-6 h-6 flex items-center justify-center text-[#B01E33]"
        >
...
export default function FAQAccordion({ items }: FAQAccordionProps) {
  ...
  return (
    <div
      className="bg-[#DEDABC] rounded-xl border border-[#D4C9B8] divide-y divide-[#D4C9B8] px-6"
