...
export default function ContactForm() {
  ...
  const inputClass =
    "w-full bg-[#DEDABC] border border-[#D4C9B8] text-[#2D3748] px-4 py-3 text-sm focus:outline-none focus:border-[#002B5C] focus:ring-2 focus:ring-[#002B5C]/10 transition-all duration-300 rounded-lg placeholder-[#B0A090]";
  ...
  return (
    <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <AnimatePresence mode="wait">
          ...
          {status === "success" && (
            <motion.div
              ...
              animate="visible"
              exit="exit"
              className="bg-[#DEDABC] rounded-xl border border-[#D4C9B8] p-8 text-center"
          ...
          {status === "limit" && (
            <motion.div
              ...
              animate="visible"
              exit="exit"
              className="bg-[#DEDABC] rounded-xl border border-[#D4C9B8] p-8"
              style={{ boxShadow: "0 2px 8px rgba(27,42,74,0.05)" }}
            >
              <div className="w-14 h-14 rounded-full bg-[#D3CEA9] flex items-center justify-center mx-auto mb-4">
      ...
      <div className="space-y-4">
        ...
        <div className="bg-[#DEDABC] rounded-xl border border-[#D4C9B8] p-6" style={{ boxShadow: '0 2px 8px rgba(27,42,74,0.05)' }}>
          <h3
