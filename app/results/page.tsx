      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        <section className="mb-20">
          ...
          {highlights.length > 0 && (
            <div className="mb-5">
              <div
                className="bg-[#E0DABF] rounded-xl border border-[#D4C9B8] overflow-hidden grid grid-cols-1 lg:grid-cols-12 items-stretch"
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            {highlights.slice(1).map((h, i) => (
              <div
                key={i}
                className="bg-[#E0DABF] rounded-xl border border-[#D4C9B8] p-6 relative overflow-hidden"
        ...
        <section>
          ...
          <div
            className="bg-[#E0DABF] rounded-xl border border-[#D4C9B8] overflow-hidden"
            style={{ boxShadow: '0 2px 8px rgba(27,42,74,0.06)' }}
          >
