...
export default function HomePage() {
  ...
  return (
    <>
      ...
      {/* ── 部の雰囲気（ヒーロー直後） ── */}
      {showClubAtmosphere && <section className="bg-[#DEDABC] py-24 lg:py-32 relative overflow-hidden">
        {/* 巨大bg watermark */}
        <div
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5">
            {ATMOSPHERE.map((item, i) => (
              <AnimatedSection key={item.num} delay={i * 0.1}>
                <div
                  className="group bg-[#DEDABC] rounded-2xl overflow-hidden card-lift"
                  style={{
                    boxShadow:
      ...
      {/* ── STATS ── */}
      <section className="bg-[#D3CEA9] relative overflow-hidden">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
      ...
      {/* ── NEWS ── */}
      <section className="bg-[#DEDABC] py-24 lg:py-32">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-5">
              ...
              <AnimatedSection className="lg:col-span-2">
                <Link
                  ...
                  className="group flex flex-col h-full min-h-[240px] lg:min-h-[300px] bg-[#DEDABC] rounded-xl card-lift p-8 lg:p-10 relative overflow-hidden"
      ...
      {/* ── 日本拳法とは（非対称レイアウト） ── */}
      <section className="bg-[#D3CEA9] py-24 lg:py-40 relative overflow-hidden">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
      ...
      {/* ── NEXT MATCH ── */}
      <AnimatedSection className="bg-[#D3CEA9] py-20 lg:py-24">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <SectionHeading en="Next Match" jp="次戦情報" className="mb-10" />
          <div
            className="bg-[#DEDABC] rounded-xl border border-[#D4C9B8] p-6 sm:p-8 lg:p-10 grid grid-cols-1 lg:grid-cols-2 gap-8 items-center"
      ...
      {/* ── GALLERY ── */}
      <section className="bg-[#D3CEA9] py-24 lg:py-32">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
