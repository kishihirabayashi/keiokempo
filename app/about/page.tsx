      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 lg:py-28">
            ...
            <div className="flex-1">
              ...
              <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
                ...
                <div className="lg:col-span-5">
                  <div
                    className="bg-[#E1DABC] rounded-xl border border-[#D4C9B8] p-6 h-full"
        ...
        <section className="mb-28">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
            {[
              ...
              <div
                key={place.name}
                className="bg-[#E1DABC] rounded-xl border border-[#D4C9B8] p-6"
                style={{ boxShadow: '0 2px 8px rgba(27,42,74,0.06)' }}
              >
        ...
        <section className="mb-28">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-3">
            {schedule.map(({ month, events }) => (
              <div
                key={month}
                className="bg-[#E1DABC] rounded-xl border border-[#D4C9B8] p-4 relative overflow-hidden"
        ...
        <section className="mb-28">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-5 gap-5">
            {/* 部長: 大きめカード */}
            <div
              className="lg:col-span-2 bg-[#E1DABC] rounded-xl border border-[#D4C9B8] p-8 flex flex-col justify-between"
              style={{ boxShadow: '0 2px 8px rgba(27,42,74,0.06)' }}
            >
              <div>
        ...
        {/* ─── OB会 ─── */}
        <section
          className="bg-[#E1DABC] rounded-xl border border-[#D4C9B8] p-8 lg:p-12 mb-8"
          style={{ boxShadow: '0 2px 8px rgba(27,42,74,0.06)' }}
        >
        ...
        {/* ─── SNS・連絡先 ─── */}
        <section
          className="bg-[#E1DABC] rounded-xl border border-[#D4C9B8] p-8 lg:p-12 mb-12"
          style={{ boxShadow: '0 2px 8px rgba(27,42,74,0.06)' }}
        >
          ...
          <div className="flex flex-wrap gap-4">
            <a
              ...
              className="bg-[#E1DABC] rounded-xl border border-[#D4C9B8] px-5 py-3 transition-all duration-200 hover:scale-[1.03] hover:shadow-md hover:border-[#B01E33]/30"
              style={{ boxShadow: '0 2px 8px rgba(27,42,74,0.04)' }}
            >
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="bg-[#E1DABC] rounded-xl border border-[#D4C9B8] px-5 py-3 transition-all duration-200 hover:scale-[1.03] hover:shadow-md hover:border-[#002B5C]/30"
              style={{ boxShadow: '0 2px 8px rgba(27,42,74,0.04)' }}
            >
