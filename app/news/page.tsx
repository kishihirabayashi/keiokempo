            ...
            <button
              ...
              className={`px-4 py-1.5 text-sm border rounded-md transition-colors duration-150 ${
                activeCategory === cat
                  ...
                  : "bg-[#E0DABF] border-[#D4C9B8] text-[#6B7A99] hover:border-[#B01E33]/40 hover:text-[#2D3748]"
              }`}
        ...
        {filtered.length > 0 && (
          <div>
            ...
            <Link
              ...
              className="block mb-5 bg-[#E0DABF] rounded-xl border border-[#D4C9B8] p-8 lg:p-10 group hover:border-[#B01E33]/30 transition-all duration-300 relative overflow-hidden"
                ...
                {filtered.slice(1).map((post) => {
                  ...
                  return (
                    <Link
                      key={post.slug}
                      href={`/news/${post.slug}`}
                      className="flex flex-col sm:flex-row gap-4 bg-[#E0DABF] rounded-xl border border-[#D4C9B8] p-5 hover:border-[#B01E33]/30 transition-all duration-300 group"
